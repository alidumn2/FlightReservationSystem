            ...
            using (var db = new AppDbContext())
            {
                ...
                if (!db.Airports.Any())
                {
                    db.Airports.AddRange(
                        ...
                        new Airport { City = "Istanbul", Name = "Sabiha Gökçen Havalimaný", Code = "SAW" },
                        new Airport { City = "Ankara", Name = "Esenboða Havalimaný", Code = "ESB" },
                        new Airport { City = "Izmir", Name = "Adnan Menderes Havalimaný", Code = "ADB" },
                        new Airport { City = "Antalya", Name = "Antalya Havalimaný", Code = "AYT" },
                        new Airport { City = "Mersin", Name = "Çukurova Uluslararasý Havalimaný", Code = "COV" },
                        new Airport { City = "Rize", Name = "Rize-Artvin Havalimaný", Code = "RZV" },
                        new Airport { City = "Trabzon", Name = "Trabzon Havalimaný", Code = "TZX" },
                        new Airport { City = "Muðla", Name = "Dalaman Havalimaný", Code = "DLM" },
                        new Airport { City = "Muðla", Name = "Milas-Bodrum Havalimaný", Code = "BJV" },
                        ...
                        new Airport { City = "Kayseri", Name = "Erkilet Havalimaný", Code = "ASR" },
                        new Airport { City = "Samsun", Name = "Çarþamba Havalimaný", Code = "SZF" },
                        new Airport { City = "Van", Name = "Ferit Melen Havalimaný", Code = "VAN" },
                        ...
                        new Airport { City = "Mardin", Name = "Prof. Dr. Aziz Sancar Havalimaný", Code = "MQM" },
                        new Airport { City = "Batman", Name = "Batman Havalimaný", Code = "BAL" },
                        new Airport { City = "Sivas", Name = "Nuri Demirað Havalimaný", Code = "VAS" },
                        new Airport { City = "Erzincan", Name = "Yýldýrým Akbulut Havalimaný", Code = "ERC" },
                        new Airport { City = "Kars", Name = "Harakani Havalimaný", Code = "KSY" },
                        new Airport { City = "Aðrý", Name = "Ahmed-i Hani Havalimaný", Code = "AJI" },
                        new Airport { City = "Iðdýr", Name = "Þehit Bülent Aydýn Havalimaný", Code = "IGD" },
                        new Airport { City = "Hakkari", Name = "Yüksekova Selahaddin Eyyubi Havalimaný", Code = "YKO" },
                        new Airport { City = "Sýrnak", Name = "Þerafettin Elçi Havalimaný", Code = "NKT" },
                        new Airport { City = "Bingöl", Name = "Bingöl Havalimaný", Code = "BGG" },
                        new Airport { City = "Muþ", Name = "Sultan Alparslan Havalimaný", Code = "MSR" },
                        ...
                        new Airport { City = "Isparta", Name = "Süleyman Demirel Havalimaný", Code = "ISE" },
                        new Airport { City = "Nevþehir", Name = "Kapadokya Havalimaný", Code = "NAV" },
                        new Airport { City = "Balýkesir", Name = "Koca Seyit Havalimaný", Code = "EDO" },
                        new Airport { City = "Canakkale", Name = "Çanakkale Havalimaný", Code = "CKZ" },
                        new Airport { City = "Kocaeli", Name = "Cengiz Topel Havalimaný", Code = "KCO" },
                        new Airport { City = "Bursa", Name = "Yeniþehir Havalimaný", Code = "YEI" },
                        new Airport { City = "Tekirdað", Name = "Çorlu Atatürk Havalimaný", Code = "TEQ" },
                        ...
                        new Airport { City = "Amasya", Name = "Merzifon Havalimaný", Code = "MZH" },
                        new Airport { City = "Zonguldak", Name = "Çaycuma Havalimaný", Code = "ONQ" },
